    ...
    public partial class UC_dashboard : UserControl
    {
        ...
        private void usercount()
        {
            try
            {
                ...
                bunifuCircleProgress4.Value = rows_count;
        ...
        private void customercount()
        {
            try
            {
                ...
                bunifuCircleProgress3.Value = rows_count;
        ...
        private void productcount()
        {
            try
            {
                ...
                bunifuCircleProgress2.Value = rows_count;
        ...
        private void orderscount()
        {
            try
            {
                ...
                bunifuCircleProgress1.Value = rows_count;
        ...
        private void bunifuCircleProgress4_ProgressChanged(object sender, Bunifu.UI.WinForms.BunifuCircleProgress.ProgressChangedEventArgs e)
        {

        }

        private void bunifuCircleProgress5_ProgressChanged(object sender, Bunifu.UI.WinForms.BunifuCircleProgress.ProgressChangedEventArgs e)
        {
