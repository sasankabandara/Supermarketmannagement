...
namespace Supermarket_Management_System_In_csharp
{
    public partial class UC_Billing : UserControl
    {
        ...
        private void bunifuButton1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    String str = "Insert Into db_orders (invodate,invono,cusname,contact,address,grandtotal)Values('" + dtp_invoicedate.Text + "','" + txt_invoiceno.Text + "','" + txt_customername.Text + "','" + txt_contact.Text + "','" + txt_address.Text + "','" + txt_grandtotal.Text + "')";
        ...
        private void bunifuButton2_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    String str = "Update db_orders Set invodate = '" + dtp_invoicedate.Text + "',contact = '" + txt_contact.Text + "',address = '" + txt_address.Text + "',grandtotal = '" + txt_grandtotal.Text + "' Where invono = '" + txt_invoiceno.Text + "' and cusid = '" + lbl_customerid.Text + "' ";
        ...
        private void bunifuButton3_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    String str = "Delete From db_orders Where invono = '" + txt_invoiceno.Text + "'";
        ...
        private void txt_productname_TextChanged_1(object sender, EventArgs e)
        {
            ///re-write code
        ...
        private void txt_productquantity_TextChanged_1(object sender, EventArgs e)
        {
            //re-write code
            try
            {
        ...
        private void txt_productname_TextChanged_2(object sender, EventArgs e)
        {
            if (txt_productname.Text == "")
            {
                txt_productprice.Clear();
